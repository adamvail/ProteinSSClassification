...
\begin{figure}[ht!]
\centering
\includegraphics[width=65mm]{results/ensemble/ROC_ALPHA.png}
\caption{}
\label{fig:roc_alpha}
\end{figure}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=65mm]{results/ensemble/ROC_BETA.png}
\caption{}
\label{fig:roc_beta}
\end{figure}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=65mm]{results/ensemble/ROC_LOOP.png}
\caption{}
\label{fig:roc_loop}
\end{figure}
